        ...
        <div class="col-md-6 col-sm-8 col-lg-5 col-xl-3 p-0">
            ...
            <div class="filter-buttons d-flex justify-content-around bg-light py-1">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu p-3">
                  <ul class="list-inline list-unstyled">
                    <li class="list-inline-item my-2">
                      <a href="card-view.php" class="btn btn-outline-dark py-1 px-3 fz-14">Card</a>
                    </li>
                    <li class="list-inline-item my-2">
                      <a href="index.php" class="btn btn-outline-dark active py-1 px-3 fz-14">Grid</a>
                    </li>
                    <li class="list-inline-item my-2">
          ...
          <?php 
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                          <div class=\"col-6 p-0 item mb-3\">
                          <a href=\"card-view.php#$id\" class=\"tdn\">
                          <img src=\"$image\" class=\"w-100\" alt=\"\">
                          <span class=\"txt text-dark p-2 d-block\">
                          <p class=\"m-0 font-weight-bold fz-16 lh-16\">$title</p>
                          <p class=\"m-0 lh-16\">$price</p>
                        </span>
                      </a>
                    </div>";   
                }

        ...
        <div class="col-md-6 col-sm-8 col-lg-5 col-xl-3 p-0">
            ...
            <div class="filter-buttons d-flex justify-content-around bg-light py-1">
              ...
              <div class="dropdown">
                ...
                <ul class="list-inline list-unstyled">
                    ...
                    <li class="list-inline-item my-2">
                      <a href="list-view.php" class="btn btn-outline-dark active py-1 px-3 fz-14">List</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <?php 
                ...
                while($row = mysqli_fetch_array($result))
                {
                    ...
                    echo "
                          <a href=\"card-view.php#$id\" class=\"item tdn d-block\">
                          <div class=\"row m-0\">
                            <div class=\"col-6 p-0\">
                              <img src=\"$image\" class=\"w-100\" alt=\"\">
                            </div>
                            <div class=\"col-6 d-flex justify-content-center flex-column\">
                              <span class=\"txt text-dark p-2 d-block text-center\">
                                <p class=\"m-0 font-weight-bold fz-16\">$title</p>
                                <p class=\"m-0\">$price</p>
                              </span>
                            </div>
                          </div>

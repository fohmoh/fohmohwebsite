...
$atitle = clean($_POST["addtitle"]);
$afooddesc = clean($_POST["addfooddesc"]);
$aprice = clean($_POST["addprice"]);
$addimg = $_SESSION["addimage"];


if(isset($_POST["submit"]) && $_POST["submit"] == "edit") {
  $_SESSION['addtitle'] = clean($_POST["addtitle"]);
  $_SESSION['addfooddesc'] = clean($_POST["addfooddesc"]);
  $_SESSION['addprice'] = clean($_POST["addprice"]);
  header('Location: newcatagory.php');
}
if (isset($_POST["submit"]) && $_POST["submit"] == "Add") {
  // username and password sent from form 
  $error = false;
  $acatagory = clean($_POST["cat"]);
  $atitle = clean($_POST["addtitle"]);
  $afooddesc = clean($_POST["addfooddesc"]);
  $aprice = clean($_POST["addprice"]);
  ...
  if($_POST["vg"] != "" && $_POST["v"] != "" && $_POST["gf"] != "" && $_POST["na"] != "")
    $error .= "Dietary Required<br>";
  ...
  if ($error == false) {
    ...
    $sql = "INSERT INTO menu(title, fooddesc, price, catagory, company, image, vegan, vegetarian, gf, extra1, extraP1, extra2, extraP2, extra3, extraP3, extra4, extraP4, extra5, extraP5) VALUES (\"$atitle\", \"$afooddesc\", \"$aprice\", \"$acatagory\", \"$acompany\", \"$addimg\", \"$vg\", \"$v\", \"$gf\", \"$extra1\", \"$extraP1\", \"$extra2\", \"$extraP2\", \"$extra3\", \"$extraP3\", \"$extra4\", \"$extraP4\", \"$extra5\", \"$extraP5\")";
  ...
  <body class="posr">
        ...
        <div class="col-xl-10 py-4 px-xl-0">
          ...
          <div class="box br-10 bg-white p-xl-3 px-xl-5 px-2 py-2 shadow shadow-sm mb-4">
            <div class="d-flex justify-content-center">
              <h5 class="m-0 fw-7 mb-4">Add Item To Menu</h5>
            </div>
          ...
          <?php } ?>
            <form action="menubuilder.php" method="POST" id="newForm" data-toggle="validator">
            <label for="">Add Photo</label>
            <p>
              <a href="addcrop.php" class="btn btn-outline-warning item br-10 d-flex justify-content-center flex-column UPLD"><i class="fas fa-plus" ></i></a>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="form-group py-2">
                  ...
                  <input type="text" class="form-control py-0 border-0 bg-light fz-14" name="addtitle" value="<?php echo $_SESSION['addtitle'];?>" required>
                  <div class="help-block with-errors"></div>
                </div>
                <div class="form-group py-2">
                  <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-4">Price</p>
                  <input type="number" class="form-control py-0 border-0 bg-light fz-14" placeholder="$" value="<?php echo $_SESSION['addprice'];?>" name="addprice" required>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-12">
                <div class="py-2 form-group">
                  ...
                  <textarea cols="30" rows="3" class="form-control py-0 border-0 bg-light fz-14" name="addfooddesc" required><?php echo $_SESSION['addfooddesc'];?></textarea>
                  <div class="help-block with-errors"></div>
                </div>
              </div>
              <div class="col-lg-7 mt-3">
                ...
                <div class="d-flex">
                  <div class="d-md-flex py-2">
                    ...
                    <input type="text" name="extra1" placeholder="Extra Cheese" class="form-control py-0 border-0 bg-light fz-12">
                  </div>
                  <div class="d-md-flex py-2 pl-3">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Price</p>
                    <input type="text" name="extraP1" class="form-control py-0 border-0 bg-light fz-12" placeholder="$23">
                  </div>
                </div>
                <div class="d-flex">
                  <div class="d-md-flex py-2">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Item</p>
                    <input type="text" name="extra2" placeholder="Without Octopus" class="form-control py-0 border-0 bg-light fz-12">
                  </div>
                  <div class="d-md-flex py-2 pl-3">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Price</p>
                    <input type="text" name="extraP2" class="form-control py-0 border-0 bg-light fz-12" placeholder="$17">
                  </div>
                </div>
                <div class="d-flex">
                  <div class="d-md-flex py-2">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Item</p>
                    <input type="text" name="extra3" placeholder="With Coffee Beans" class="form-control py-0 border-0 bg-light fz-12">
                  </div>
                  <div class="d-md-flex py-2 pl-3">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Price</p>
                    <input type="text" name="extraP3" class="form-control py-0 border-0 bg-light fz-12" placeholder="$20">
                  </div>
                </div>
                <div class="d-flex">
                  <div class="d-md-flex py-2">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Item</p>
                    <input type="text" name="extra4" placeholder="" class="form-control py-0 border-0 bg-light fz-12">
                  </div>
                  <div class="d-md-flex py-2 pl-3">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Price</p>
                    <input type="text" name="extraP4" class="form-control py-0 border-0 bg-light fz-12" placeholder="$">
                  </div>
                </div>
                <div class="d-flex">
                  <div class="d-md-flex py-2">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Item</p>
                    <input type="text" name="extra5" placeholder="" class="form-control py-0 border-0 bg-light fz-12">
                  </div>
                  <div class="d-md-flex py-2 pl-3">
                    <p class="m-0 mb-1 mb-md-0 d-flex justify-content-center flex-column pr-2 small">Price</p>
                    <input type="text" name="extraP5" class="form-control py-0 border-0 bg-light fz-12" placeholder="$">
                  </div>
                </div>  
                <h6>Category</h6>
                <ul class="list-inline list-unstyled">
                  <li class="list-inline-item">
                    <button type="submit" name="submit" value="edit" class="btn btn-sm btn-outline-warning py-0">Edit Catagories</button>
                  </li>
                  <?php
                    $company = $_SESSION['company'];
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        echo "<a href=\"#\" class=\"CAT btn btn-sm btn-outline-warning OPT py-0\">", $row["catagory"],"</a>";
                        echo "<input name=\"cat\" type=\"radio\" class=\"sr-only\" value=\"", $row["catagory"],"\"></li>";
                    }
                ...
                <ul class="list-inline list-unstyled">
                  <li class="list-inline-item">
                    <a href="#" class="CAT btn btn-sm btn-outline-warning OPTCH py-0">Vegan</a>
                    <input name="vg" type="checkbox" class="sr-only">
                  </li>
                  <li class="list-inline-item">
                    <a href="#" class="CAT btn btn-sm btn-outline-warning OPTCH py-0">Vegetarian</a>
                    <input name="v" type="checkbox" class="sr-only">
                  </li>
                  <li class="list-inline-item">
                    <a href="#" class="CAT btn btn-sm btn-outline-warning OPTCH py-0">Gluten Free</a>
                    <input name="gf" type="checkbox" class="sr-only">
                  </li>
                  <li class="list-inline-item">
                    <a href="#" class="CAT btn btn-sm btn-outline-warning OPTCH py-0">N/A</a>
                    <input name="na" type="checkbox" class="sr-only">
                  </li>
                </ul>
                <div class="help-block with-errors help-block1"></div>
                
                <button type="submit" name="submit" value="Add"  class="btn btn-primary submitBtn">Add Item To Menu</button> 
              </div>
              <!--div class="col-12 py-2">
                <h6>Dietary <span class="small text-muted">Optional</span></h6>
                <ul class="list-inline list-unstyled">
                  <li class="list-inline-item">
                    <a href="#" class="btn btn-sm btn-outline-warning OPT py-0">Breakfast</a>
                ...
                <div class="col-12">
                  <p class="text-center m-0 mt-5">
                    <button class="btn btn-warning px-5 shadow fw-7">Add Item</button>
                  </p>
                </div>
              </div-->
            </div>
    ...
    <script>
      ...
      $( document ).ready(function() {
        <?php if (isset($addimg)){echo "
        $('.UPLD').css('background-image', 'url($addimg)');
        $('.UPLD').children('i.fas').hide('fast');
        ";} ?>
      });

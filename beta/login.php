<?php
   ...
   // Prepare our SQL, preparing the SQL statement will prevent SQL injection.
    if ($stmt = $connection->prepare('SELECT id, passcode, company FROM users WHERE email = ?')) {
          ...
          <div class="col-xl-4 col-lg-5 col-md-6 col-sm-9">
              ...
              <form method="post" action="login.php" id="loginForm"  data-toggle="validator">
                <div class="item mb-3">
                  ...
                  <input type="email" name="username" class="form-control py-4" autofocus="" required="">
                </div>
                <div class="item mb-3">
                  <label for="" class="text-uppercase m-0">Password</label>
                  <input type="Password" name="password" class="form-control py-4" required="">
                </div>
                <button type="submit" class="btn btn-danger w-100 py-3 mt-4">Sign In</button>
                <p class="text-center my-3">
                  <a href="#" class="border-bottom border-danger text-dark fw-4 tdn">Forgot your password?</a>
                </p>
                <p class="text-center my-3">
                  <span>Don't have an account yet?</span>
                  <a href="signup.php" class="border-bottom border-danger text-danger fw-4 tdn">Sign up here</a>
                </p>
              </form>
          </div>
        </div>
